    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(ezy_Users model, string returnUrl)
        {
            ...
            if (result != null)
            {
                ...
                nameCookie.Values["LoginMainUser"] = model.UserID.ToString();
                ...
                SetupFormsAuthTicket(result, false);


                var dd = db.Ezy_Groupusers.Where(x => x.UserID == result.UserID).FirstOrDefault();
