                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    if (dt.Rows[i].ItemArray[0] != null && dt.Rows[i].ItemArray[1] != null)
                    {
                        ...
                        if (dd == null)
                        {
                            ...
                            Tool.MoldToolingPartNumber = dt.Rows[i].ItemArray[2].ToString();
                            Tool.MoldToolingPrintNumber = dt.Rows[i].ItemArray[3].ToString();
                            Tool.MoldToolingVendor = dt.Rows[i].ItemArray[4].ToString();
                            if (!(dt.Rows[i].ItemArray[5] is DBNull))
                                Tool.MoldToolCost = Convert.ToDecimal(String.Format("{0:N}", dt.Rows[i].ItemArray[5]));

                            //Tool.MoldToolCost =  dt.Rows[i].ItemArray[5].ToString();
                            if (!(dt.Rows[i].ItemArray[6] is DBNull))
                                Tool.MoldToolingPartsOnHand = Convert.ToInt32(dt.Rows[i].ItemArray[6]);

                            //Tool.MoldToolingPartsOnHand = dt.Rows[i].ItemArray[6].ToString();

                            if (!(dt.Rows[i].ItemArray[7] is DBNull))
                                Tool.MoldToolingReorderLevel = Convert.ToInt32(dt.Rows[i].ItemArray[7]);

                            //Tool.MoldToolingReorderLevel = dt.Rows[i].ItemArray[7].ToString();

                            if (!(dt.Rows[i].ItemArray[8] is DBNull))
                                Tool.MoldToolingNumOrdered = Convert.ToInt32(dt.Rows[i].ItemArray[8]);

                            //Tool.MoldToolingNumOrdered = dt.Rows[i].ItemArray[8].ToString();

                            if (!(dt.Rows[i].ItemArray[9] is DBNull))
                                Tool.MoldToolingDateOrdered = Convert.ToDateTime(dt.Rows[i].ItemArray[9]);

                            //Tool.MoldToolingDateOrdered = dt.Rows[i].ItemArray[9].ToString();

                            if (!(dt.Rows[i].ItemArray[10] is DBNull))
                                Tool.MoldToolingNumReceived = Convert.ToInt32(dt.Rows[i].ItemArray[10]);

                            //Tool.MoldToolingNumReceived = dt.Rows[i].ItemArray[10].ToString();
