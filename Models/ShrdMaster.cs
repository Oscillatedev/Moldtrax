    ...
    string viewName, object model)
        ...
        public bool SendEmail(string receiver, string subject, string message)
        {
            try
            {
                    ...
                    MailAddress address = new MailAddress("infodatixhosting@gmail.com");
                    msg.From = address;
                    msg.Subject = subject;
                    msg.Body = message;
                    ...
                    NetworkCredential credentials = new NetworkCredential("infodatixhosting@gmail.com", "Popup$$1234");
