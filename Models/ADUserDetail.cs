...
namespace ActiveDirectoryWebApp.Models
{
    public class ADUserDetail
    {
        ...
        private String _DisplayPhysicalOfficeName;
        ...
        public string DisplayPhysicalOfficeName
        {
            get { return _DisplayPhysicalOfficeName; }
        }
        ...
        public ADUserDetail(DirectoryEntry directoryUser)
        {
            ...
            _DisplayPhysicalOfficeName = GetProperty(directoryUser, ADProperties.PHYSICALDELIVERYOFFICENAME);
